...
def main():
	...
	while True:
		...
		# Aquí hacemos el split y lo convertimos a minúsculas
		parts = user_input.lower().split()
		print(f"Partes de la entrada: {parts}")

		# Aquí podrías manejar las partes según tu lógica
		# Por ejemplo, si querés hacer algo específico con la primera parte
